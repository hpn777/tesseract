...
class EventHorizon{
    ...
    registerTesseract(newTesseract) {
        ...
        resolvedColumns.forEach(column => {
            ...
            if (childrenTable) {
                childrenTable.off('update dataRemoved')
                childrenTable.on('update dataRemoved', data => {
        ...
        this.tesseracts.forEach(tesseract => {
            ...
            if(resolved.length) {
                newTesseract.off('update dataRemoved')
                newTesseract.on('update dataRemoved', data => {
